...
import { editInteractionReply } from "./editInteractionReply";

/**
 * Verifica se o usuário possui a permissão necessária para executar um comando.
 *
 * @param interaction - A interação do comando que está sendo verificada.
 * @param permission - A permissão necessária que está sendo verificada.
 * @returns Uma Promise que resolve para `true` se o usuário tiver a permissão, ou rejeita com uma mensagem de erro se não tiver.
 *
 * @throws Se ocorrer um erro durante a verificação da permissão, a Promise será rejeitada com o erro.
 */
